...
export function PaytmButton () {
    ...
    const initialize = () => {
        ...
        // Sandbox Credentials
        let mid = "xmeoih86259642588733"; // Merchant ID
        let mkey = "XKhdo2DpsZVJPo1a"; // Merhcant Key
        var paytmParams = {};
        ...
        <div style={{paddingTop:"10px"}}>
            {
                loading ? (
                  ...
                  <button type="button" class="btn btn-dark btn-block btn-lg"
                    data-mdb-ripple-color="dark" onClick={makePayment}>Pay with Paytm</button>
                )
            }
        </div>
    )
