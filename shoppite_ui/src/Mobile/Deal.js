     ...
     { !completed ? ( 
      ...
      <div className="row ">
        <div className="col-md-6 col-xl-6 col-lg-6  col-sm-6 col-xs-12 col-12  deal">
         <NavLink to="../category/acces"> <img src={window.location.origin + '/deal_1630.gif'} className="deal_gif" /></NavLink>
        </div>

        <div className="col-md-6 col-xl-6 col-lg-6 col-sm-6 col-xs-12 col-12 deal">
        <NavLink to="../category/acces"><img src={window.location.origin + '/deal_2.png'} className="deal_gif" /></NavLink>
        </div>
        <div class="card-group row women_page ">
          
          <div class="card col-md-3 col-xl-3 col-lg-3 col-sm-6 col-xs-6 col-6 deal_cards">
          <NavLink to="../shoes"><img src={window.location.origin + '/103.png'} alt="" /></NavLink>
 
          </div>
          <div class="card col-md-3 col-xl-3 col-lg-3 col-sm-6 col-xs-6 col-6 deal_cards">
          <NavLink to="../category/acces"><img src={window.location.origin + '/105.png'} alt="" /></NavLink>
          </div>
          <div class="card col-md-3 col-xl-3 col-lg-3 col-sm-6 col-xs-6 col-6 deal_cards">
          <NavLink to="../category/clothing">    <img src={window.location.origin + '/repro_102.png'} alt="" /></NavLink>

          </div>
          <div class="card col-md-3 col-xl-3 col-lg-3 col-sm-6 col-xs-6 col-6 deal_cards">
          <NavLink to="../category/electric">  <img src={window.location.origin + '/re_103.png'} alt="" /></NavLink>
          </div>
        </div>
        ...
        <div class="card-group row women best_gutter">
          <div class="card col-md-12 col-xl-12 col-lg-12 col-sm-4 col-xs-4 col-6 ">
