        ...
        { !completed ? ( 
          ...
          {! loading ? ( 
            ...
            <div className="col-md-12 col-xl-12 col-lg-12 col-sm-12 col-xs-12 col-12 shoppite_best">
                <img src={window.location.origin + '/top_offer.png'} alt="shopite_best_seller" className="best_seller_ban" style={{ "width": "100%" }} />
            </div>
            <div className="row">
                <Filtercheck />
                <div className=" col-md-9 col-xl-9 col-lg-9 col-sm-12 col-xs-12 col-12 laptops">
                    <div>
                        <img src={window.location.origin + '/offer_clothing.png'} alt="shopite_best_seller" className="best_seller_ban" style={{ "width": "100%" }} />
                    </div>
                    <div class="card-group row ">
                        <div className="row women_page">
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps ">
                                <img src={window.location.origin + '/offer_101.png'} alt="" />
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_102.png'} alt="" />
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_103.png'} alt="" />
                                <NavLink to="./discript_women"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">Shopmart</div>
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_104.png'} alt="" />
                                <NavLink to="./discript_women"> <div class="card-body row link_css">
                                    <div className="col-12 compny_name">Shopmart</div>
                    ...
                    <div class="card-group row ">
                        <div className="row women_page">
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps ">
                                <img src={window.location.origin + '/offer_105.png'} alt="" />
                                <NavLink to="./discript_men"><div class="card-body row body_for_women link_css">
                                    <div className="col-12 compny_name">TagsForever</div>
                                    <div className="col-12 pro_name">Green Color Suit</div>
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_106.png'} alt="" />
                                <NavLink to="./discript_men"> <div class="card-body row link_css">
                                    <div className="col-12 compny_name">TagsForever</div>
                                    <div className="col-12 pro_name">Light Grey Blezer</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" />1599</span></div>
                                    {/* <div className="col-12 offer_price">10% Off</div> */}

                                </div></NavLink>
                            </div>
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_107.png'} alt="" />
                                <NavLink to="./discript_men"> <div class="card-body row link_css">
                                    <div className="col-12 compny_name">TagsForever</div>
                                    <div className="col-12 pro_name">Blue WesternWear</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" /> 999</span></div>
                                    {/* <div className="col-12 offer_price">25% Off</div> */}
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_108.png'} alt="" />
                                <NavLink to="./discript_men"> <div class="card-body row link_css">
                                    <div className="col-12 compny_name">TagsForever</div>
                                    <div className="col-12 pro_name">Light Blue Dress</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" /> 1999 </span></div>
                                    {/* <div className="col-12 offer_price">20% Off</div> */}
                    ...
                    <div>
                        <img src={window.location.origin + '/offer_elec.png'} alt="shopite_best_seller" className="best_seller_ban" style={{ "width": "100%" }} />
                    </div>
                    <div class="card-group row ">
                        <div className="row women_page">
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps ">
                                <img src={window.location.origin + '/offer_109.png'} alt="" />
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_110.png'} alt="" />
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_111.png'} alt="" />
                                <NavLink to="./discript_lap"><div class="card-body row link_css">
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_112.png'} alt="" />
                                <NavLink to="./discript_lap"><div class="card-body row link_css">
                    ...
                    <div>
                        <img src={window.location.origin + '/offer_footwear.png'} alt="shopite_best_seller" className="best_seller_ban" style={{ "width": "100%" }} />
                    </div>
                    <div class="card-group row ">
                        <div className="row women_page">
                         
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_113.png'} alt="" />
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_114.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">SSS</div>
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_115.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">SSS</div>
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_116.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                    ...
                    <div class="card-group row ">
                        <div className="row women_page">
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_117.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">Basket</div>
                                    <div className="col-12 pro_name">White Sports Shoes</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" />999</span></div>
                                    {/* <div className="col-12 offer_price">10% Off</div> */}
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_119.png'} alt="" />
                                <NavLink to="./discript_footwear"> <div class="card-body row link_css">
                                    <div className="col-12 compny_name">Basket</div>
                                    <div className="col-12 pro_name">Brown Formal Shoes</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" /> 899</span></div>
                                    {/* <div className="col-12 offer_price">25% Off</div> */}
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_118.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">Basket</div>
                                    <div className="col-12 pro_name">Black Shoes</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" /> 999 </span></div>
                            ...
                            <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
                                <img src={window.location.origin + '/offer_120.png'} alt="" />
                                <NavLink to="./discript_footwear"><div class="card-body row link_css">
                                    <div className="col-12 compny_name">Basket</div>
                                    <div className="col-12 pro_name">Black Formal Shoes</div>
                                    <div className="col-12 price"><span><Icon icon="fa6-solid:indian-rupee-sign" /> 1999 </span></div>
                                    {/* <div className="col-12 offer_price">20% Off</div> */}
