...
<div className="row women_page">
    ...
    <img src={window.location.origin + '/seller_101.png'} alt="" />
  <NavLink to="./discript"><div class="card-body row body_for_women link_css">
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_102.png'} alt=""/>
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_103.png'} alt=""/>
    <div class="card-body row link_css">
     <div className="col-12 compny_name">SHAIN</div> 
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_104.png'} alt=""/>
    <div class="card-body row link_css">
     <div className="col-12 compny_name">SHAIN</div> 
...
<div className="row women_page">
      <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps ">
    <img src={window.location.origin + '/seller_105.png'} alt="" />
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_106.png'} alt=""/>
    <div class="card-body row link_css">
     <div className="col-12 compny_name">SHAIN</div> 
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_107.png'} alt=""/>
    <div class="card-body row link_css">
  ...
  <div class="card  col-md-3 col-xl-3 col-lg-3  col-sm-6 col-xs-6 col-6 laps">
    <img src={window.location.origin + '/seller_108.png'} alt=""/>
    <div class="card-body row link_css">
     <div className="col-12 compny_name">DLINGGER</div> 
