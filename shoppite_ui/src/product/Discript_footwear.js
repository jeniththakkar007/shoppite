...
export class Discript_footwear extends React.Component {
                            ...
                            <div class="wrapper row">
                                <div className="row">
                                    ...
                                    <Carousel showArrows={true} className="pictures col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-12">
                                        <div>
                                            <img src={window.location.origin + '/dist_112.png'} />

                                        </div>
                                        <div>
                                            <img src={window.location.origin + '/dist_113.png'} />

                                        </div>
                                        <div>
                                            <img src={window.location.origin + '/dist_114.png'} />

                                        </div>
                                        <div>
                                            <img src={window.location.origin + '/dist_115.png'} />

                                        </div>
                                        <div>
                                            <img src={window.location.origin + '/dist_116.png'} />
                                    ...
                                    <div class="details col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-12">
                                        <h3 class="product-title"> Mustard Yellow Braided Wedges</h3>
                                        <div class="rating">
                                            <div class="stars">
                                        ...
                                        <p class="product-description">
                                            A pair of mustard yellow open toe heels, has regular ankle and buckle
                                            PU braided upper
                                            Cushioned footbed
                                            Textured and patterend outsole, has a wedge heel
                                            Warranty: 1 month
                                            Warranty provided by Brand Owner / Manufacturer</p>
                                        <h4 class="price">current price: <span><Icon icon="ph:currency-inr-bold" /> 804</span></h4>
                                        <p class="vote"><strong>91%</strong> of buyers enjoyed this product! <strong>(87 votes)</strong></p>
                                        <h5 class="sizes">sizes:
                                            <span class="size" data-toggle="tooltip" title="small">36</span>
                                            <span class="size" data-toggle="tooltip" title="medium">38</span>
                                            <span class="size" data-toggle="tooltip" title="large">40</span>
                                            <span class="size" data-toggle="tooltip" title="xtra large">46</span>
                                        </h5>
